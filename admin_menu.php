...
<tr>
<td style='width:30%' class='button'>";
if (e_PAGE == "admin_new_event.php") {
$text1 .= "
<b><a style='cursor:hand; cursor:pointer; text-decoration:none;' href='admin_new_event.php'>>> Create Event <<</a></b>";
} else {
 $text1 .="
<a style='cursor:hand; cursor:pointer; text-decoration:none;' href='admin_new_event.php'>Create Event</a>";}
...
<tr>
<td style='width:30%' class='button'>";
if (e_PAGE == "admin_edit_event.php") 
{$text1 .= "
<b>
<a style='cursor:hand; text-decoration:none' href='admin_edit_event.php'>>> Edit Event <<</a>
</b>";}
else
{$text1 .= "
<a style='cursor:hand; text-decoration:none' href='admin_edit_event.php'>Edit Event</a>";}
...
<tr>
<td style='width:30%' class='button'>";
if (e_PAGE == "admin_addevent_det.php") 
{$text1 .= "
<b>
<a style='cursor:hand; text-decoration:none' href='admin_addevent_det.php'>>> Add/Remove Users <<</a>
</b>";}
else
{$text1 .= "
<a style='cursor:hand; text-decoration:none' href='admin_addevent_det.php'>Add/Remove Users</a>";}
